...
function mouseDragged(){
    ...
    //how do we only draw the shape that the user wants:
    /*
        if the user selected the circle shape(if shape === 'circle'):
            draw the circle
        else if they selected the square shape(else if shape === 'square'):
            draw a square
        else:(else if shape === 'triangle')
            draw a triangle
    */
